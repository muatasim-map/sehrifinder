...
export const LandingPage: React.FC<LandingPageProps> = ({ onEnterApp }) => {
  ...
  return (
    <div className="font-landing-body text-neutral-800 overflow-x-hidden w-full bg-emerald-midnight">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-emerald-midnight/95 backdrop-blur-md py-3 shadow-lg border-b border-gold-lantern/10' : 'bg-transparent py-6'}`}>
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-landing-accent font-medium text-neutral-pearl/90">
            {['Story', 'Features', 'Cities'].map((item) => (
              <button 
                key={item} 
        ...
        <div ref={heroContentRef} className="relative z-10 max-w-5xl mx-auto text-center space-y-8 mt-24 will-change-transform">
           ...
           <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
             ...
             <button 
               ...
               className="flex items-center gap-2 px-8 py-4 rounded-full border border-gold-lantern/30 text-neutral-pearl font-landing-accent font-medium hover:bg-white/5 transition-colors"
             >
      ...
      <section className="relative py-20 bg-cream border-b border-gold-lantern/10">
         <div className="container mx-auto px-6 text-center max-w-4xl relative z-10 reveal">
            ...
            <div className="relative">
              ...
              <blockquote className="font-serif text-3xl md:text-5xl text-emerald-midnight leading-tight mb-6 italic px-4">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8 text-center md:text-left">
              ...
              <div className="reveal font-landing-body text-lg text-emerald-midnight/70 space-y-6 leading-relaxed bg-white/50 backdrop-blur-sm p-8 rounded-2xl border border-gold-antique/30 shadow-[0_0_15px_rgba(184,134,11,0.05)] relative" style={{ transitionDelay: '200ms' }}>
      ...
      <section id="features" className="py-16 bg-emerald-midnight relative overflow-hidden border-t border-gold-lantern/10">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-12 reveal">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gold-lantern/5 border border-gold-lantern/20 text-gold-lantern text-[10px] font-bold uppercase tracking-widest mb-4">
               <span className="w-1.5 h-1.5 rounded-full bg-gold-lantern animate-pulse"></span>
               Key Features
            </div>
            <h2 className="font-landing-heading text-3xl md:text-5xl text-neutral-pearl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <FeatureCard 
              ...
              title="Masjid Sehri"
              tag="Spiritual"
              desc="Communal meals in Masjids with Tahajjud prayers & community warmth."
            />
            <FeatureCard 
              delay={100}
              ...
              tag="No Cost"
              desc="Verified distribution points run by trusts & generous individuals."
            />
             <FeatureCard 
              delay={200}
              ...
              tag="Safe Space"
              desc="Verified spots with separate arrangements and respectful environments."
            />
            <FeatureCard 
              delay={300}
              ...
              tag="Welcoming"
              desc="Away from home? Find spots near hostels, transit hubs, and campuses."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-emerald-midnight relative border-t border-white/5 border-b border-white/5">
         ...
         <div className="container mx-auto px-6 relative z-10 flex justify-center">
            {/* Removed border and hover border/shadow classes */}
            <div className="reveal max-w-3xl w-full bg-white/[0.02] backdrop-blur-md rounded-2xl p-8 md:p-12 text-center relative overflow-hidden group transition-all duration-500">
               ...
               {/* Updated Typography and Quotes */}
               <p className="font-serif text-xl md:text-3xl text-neutral-ivory/80 leading-relaxed italic max-w-2xl mx-auto mb-8 tracking-wide">
      ...
      <section id="cities" className="py-24 bg-cream relative">
         ...
         <div className="container mx-auto px-6 relative z-10">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
             {/* Chennai (Active) */}
             <div className="reveal bg-emerald-midnight rounded-xl p-8 text-white relative overflow-hidden group hover:-translate-y-2 transition-all duration-300 border border-gold-lantern/60 hover:border-gold-lantern shadow-[0_0_20px_rgba(212,175,55,0.15)]">
      ...
      {/* HELP US SECTION */}
      <section id="help-us" className="py-24 bg-cream relative border-t border-gold-lantern/10">
         <div className="absolute inset-0 opacity-[0.05] pointer-events-none">
            <IslamicPattern variant="geometric" className="text-emerald-midnight" />
         </div>
         ...
         <div className="container mx-auto px-6 relative z-10">
            <div className="text-center mb-16 reveal">
               ...
               <h2 className="font-landing-heading text-4xl md:text-5xl text-emerald-midnight mb-6">
                 Help Us <span className="text-gold-antique italic">Serve Better</span>
               </h2>
               <p className="font-landing-body text-lg text-emerald-midnight/70 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
               {/* Submit */}
               <div className="reveal bg-white p-8 rounded-2xl border border-gold-antique/60 shadow-sm hover:border-gold-antique hover:shadow-[0_10px_40px_-10px_rgba(184,134,11,0.2)] transition-all group text-center cursor-default">
                  <div className="w-16 h-16 mx-auto bg-emerald-sacred/5 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border border-emerald-sacred/10">
                     <PlusCircle className="w-8 h-8 text-emerald-sacred" />
                  </div>
                  <h3 className="font-landing-heading text-2xl text-emerald-midnight mb-3">Add a Spot</h3>
                  <p className="text-stone-500 text-sm mb-8 leading-relaxed font-landing-body">
                    Know a Masjid, trust, or restaurant offering Sehri? Submit the details so others can benefit.
                  </p>
                  <a href="mailto:contribute@sehrifinder.com?subject=New Sehri Spot Submission" className="inline-flex items-center gap-2 text-emerald-sacred font-bold text-xs uppercase tracking-widest hover:text-emerald-forest transition-colors border-b border-emerald-sacred/30 pb-0.5 hover:border-emerald-sacred">
                    Submit Details <ArrowRight size={14} />
                  </a>
               </div>

               {/* Verify - Updated Colors to Rose */}
               <div className="reveal bg-white p-8 rounded-2xl border border-gold-antique/60 shadow-sm hover:border-gold-antique hover:shadow-[0_10px_40px_-10px_rgba(184,134,11,0.2)] transition-all group text-center cursor-default" style={{ transitionDelay: '100ms' }}>
                  <div className="w-16 h-16 mx-auto bg-rose-50 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border border-rose-100">
                     <CheckCircle2 className="w-8 h-8 text-rose-600" />
                  </div>
                  <h3 className="font-landing-heading text-2xl text-emerald-midnight mb-3">Verify Data</h3>
                  <p className="text-stone-500 text-sm mb-8 leading-relaxed font-landing-body">
                    Spotted an error? Closed location? Timing change? Let us know immediately to fix it.
                  </p>
                  <a href="mailto:contribute@sehrifinder.com?subject=Data Correction" className="inline-flex items-center gap-2 text-rose-600 font-bold text-xs uppercase tracking-widest hover:text-rose-800 transition-colors border-b border-rose-200 pb-0.5 hover:border-rose-600">
                    Report Issue <ArrowRight size={14} />
                  </a>
               </div>

               {/* Volunteer */}
               <div className="reveal bg-white p-8 rounded-2xl border border-gold-antique/60 shadow-sm hover:border-gold-antique hover:shadow-[0_10px_40px_-10px_rgba(184,134,11,0.2)] transition-all group text-center cursor-default" style={{ transitionDelay: '200ms' }}>
                  <div className="w-16 h-16 mx-auto bg-gold-lantern/5 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border border-gold-lantern/20">
                     <Users className="w-8 h-8 text-gold-antique" />
                  </div>
                  <h3 className="font-landing-heading text-2xl text-emerald-midnight mb-3">Join the Team</h3>
                  <p className="text-stone-500 text-sm mb-8 leading-relaxed font-landing-body">
                    We need city leads, verifiers, and tech volunteers. Be part of the team behind Sehri Finder.
                  </p>
                  <a href="mailto:join@sehrifinder.com?subject=Volunteering" className="inline-flex items-center gap-2 text-gold-antique font-bold text-xs uppercase tracking-widest hover:text-gold-dark transition-colors border-b border-gold-antique/30 pb-0.5 hover:border-gold-antique">
...
// --- SUB-COMPONENTS (Added inline to resolve Reference Errors) ---
...
const LanternSVG = ({ 
  ...
  const isHighFlicker = flickerIntensity === 'high';
  
  return (
    <div className={`relative ${className} flex justify-center`}>
       {/* Outer Glow */}
       <div 
         className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] rounded-full blur-2xl lantern-glow-core pointer-events-none ${isHighFlicker ? 'animate-pulse' : ''}`}
         style={{ background: `radial-gradient(circle, ${glowColor} 0%, transparent 70%)`, opacity: 0.4 }}
       />
       
       <svg viewBox="0 0 100 160" className="w-full h-auto drop-shadow-2xl overflow-visible">
          {/* Hanger Ring */}
          <circle cx="50" cy="5" r="5" fill="none" stroke="currentColor" strokeWidth="2" />
          
          {variant === 'royal' && (
            <g transform="translate(0, 10)">
               {/* Top Cap */}
               <path d="M50 0 L70 20 L30 20 Z" fill="currentColor" opacity="0.9" />
               {/* Body */}
               <path d="M30 20 L20 50 L30 100 L50 120 L70 100 L80 50 L70 20 Z" fill="none" stroke="currentColor" strokeWidth="2" />
               {/* Inner pattern */}
               <path d="M50 20 L50 120 M20 50 L80 50 M30 100 L70 100" stroke="currentColor" strokeWidth="1" opacity="0.5" />
               {/* Bottom Tassel holder */}
               <circle cx="50" cy="125" r="3" fill="currentColor" />
            </g>
          )}
          ...
          {variant === 'geometric' && (
            <g transform="translate(0, 10)">
              {/* Diamond Body */}
              <path d="M50 0 L80 50 L50 110 L20 50 Z" fill="none" stroke="currentColor" strokeWidth="2" />
              <path d="M50 0 L50 110 M20 50 L80 50" stroke="currentColor" strokeWidth="1" opacity="0.5" />
          ...
          {variant === 'simple' && (
             <g transform="translate(0, 10)">
               <rect x="35" y="0" width="30" height="10" rx="2" fill="currentColor" opacity="0.8" />
               <path d="M35 10 L25 30 L25 80 L35 100 L65 100 L75 80 L75 30 L65 10 Z" fill="none" stroke="currentColor" strokeWidth="2" />
               <line x1="35" y1="10" x2="35" y2="100" stroke="currentColor" strokeWidth="1" opacity="0.3" />
               <line x1="65" y1="10" x2="65" y2="100" stroke="currentColor" strokeWidth="1" opacity="0.3" />
             </g>
          )}
          
          {/* Inner Light/Flame */}
          <circle cx="50" cy={variant === 'geometric' ? 60 : 65} r="10" fill={glowColor} className="blur-sm opacity-80 animate-[flicker-candle_4s_infinite]" />
       </svg>
    </div>
  );
};
...
const FeatureCard = ({ delay, icon, title, tag, desc }: { delay: number, icon: React.ReactNode, title: string, tag: string, desc: string }) => (
  <div className="reveal bg-emerald-sacred/5 border border-gold-lantern/40 hover:border-gold-lantern hover:shadow-[0_0_20px_rgba(212,175,55,0.1)] p-5 rounded-2xl transition-all duration-300 hover:-translate-y-1 h-full" style={{ transitionDelay: `${delay}ms` }}>
    <div className="mb-4 text-gold-lantern bg-gold-lantern/10 w-12 h-12 rounded-full flex items-center justify-center border border-gold-lantern/20">
      {icon}
    </div>
    <div className="text-[10px] font-bold text-gold-antique uppercase tracking-widest mb-2">{tag}</div>
    <h3 className="text-lg font-landing-heading text-neutral-pearl mb-2">{title}</h3>
    <p className="text-sm text-neutral-400 font-landing-body leading-relaxed">{desc}</p>
  </div>
);

const CityCard = ({ name, status, desc, delay }: { name: string, status: string, desc: string, delay: number }) => (
  <div className="reveal bg-white p-6 rounded-xl border border-gold-antique/60 hover:border-gold-antique hover:shadow-lg flex items-center justify-between group transition-all" style={{ transitionDelay: `${delay}ms` }}>
    <div>
      <h3 className="font-landing-heading text-2xl text-emerald-midnight mb-1">{name}</h3>
      <p className="text-xs text-stone-500 font-medium uppercase tracking-wide mb-2">{status}</p>
      <p className="text-sm text-stone-500 font-landing-body max-w-[200px]">{desc}</p>
    </div>
    <div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center text-stone-400 group-hover:bg-gold-lantern group-hover:text-emerald-midnight transition-colors">
