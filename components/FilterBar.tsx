          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            ...
            <div className="relative w-full sm:w-56 z-50">
              <button 
                ...
                className="w-full flex items-center justify-between bg-white border border-gold-antique/60 text-stone-700 py-3 px-4 rounded-xl shadow-sm hover:border-gold-antique hover:shadow-md transition-all group active:scale-[0.99]"
              >
