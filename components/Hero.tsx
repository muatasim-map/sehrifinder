  ...
  return (
    <div className="relative bg-gradient-to-b from-primary to-primary-dark text-white pb-10 pt-12 px-4 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto text-center">
        ...
        {/* Disclaimer Banner */}
        <div className="max-w-xl mx-auto mb-6 bg-white/10 backdrop-blur-md rounded-lg p-3 border border-gold-bright/60 flex items-start gap-3 text-left shadow-lg">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="relative group">
            <input
              ...
              className="w-full bg-white/10 backdrop-blur-md border border-gold-bright/60 text-white placeholder-white/80 rounded-2xl py-5 pl-14 pr-4 focus:outline-none focus:ring-2 focus:ring-gold-bright focus:bg-white/20 transition-all text-lg shadow-xl"
            />
        ...
        <div className="flex flex-wrap justify-center gap-3 text-sm font-medium">
          <button className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-5 py-2.5 rounded-full border border-gold-bright/40 backdrop-blur-sm transition-all hover:scale-105 active:scale-95 group">
